...
import { modularExpressionFor, modularExpressionUrl } from "../character/ModularExpressionAssets";
...
export function FaceRig({ face, calibration, assets, time, playing, headMotion = { rotation: 0, x: 0, y: 0 }, resolveAssetUrl = identity }: Props) {
  ...
  const assetState = assets ?? { activeMouthPack: "v3", activeEyePack: "expressive", mouthOverrides: {}, eyeOverrides: {}, browOverrides: {} };
  ...
  const modularSlug = modularExpressionFor(baseExpression), useSilentExpressionMouth = assetState.activeEyePack === "modular-v2" && preview.mouth === "REST";
  ...
  return <g className="face-rig" pointerEvents="none">
    ...
    {assetState.activeEyePack === "modular-v2" && <image data-face-effect="expression-shading-v2" href={resolveAssetUrl(modularExpressionUrl(modularSlug, "face-shading"))} x="824" y="118" width="140" height="140" opacity=".72" clipPath={`url(#expression-face-${cryId})`}/>}
